...
func StartWorker() {
	...
	w.RegisterWorkflowWithOptions(mutexWorkflow, workflow.RegisterOptions{Name: "cadence_samples.mutexWorkflow"})
	w.RegisterWorkflowWithOptions(sampleWorkflowWithMutex, workflow.RegisterOptions{Name: "cadence_samples.sampleWorkflowWithMutex"})
	w.RegisterActivityWithOptions(signalWithStartMutexWorkflowActivity, activity.RegisterOptions{Name: "cadence_samples.signalWithStartMutexWorkflowActivity"})
